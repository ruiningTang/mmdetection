...
from ..utils import simam_module
...
class ResNetAM(BaseModule):
    ...
    def __init__(self, 
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNetAM, self).__init__(init_cfg)
        ...
        self.layer1 = self._make_layer(block, 64, stage_blocks[0], 
                                       attention_module=attention_module,init_cfg=block_init_cfg)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False, attention_module=None,**kwargs):
        ...
        layers.append(block(self.inplanes, planes, stride, downsample, self.groups,
                            self.base_width, previous_dilation, norm_layer, attention_module,**kwargs))
        self.inplanes = planes * block.expansion
        for _ in range(1, blocks):
            layers.append(block(self.inplanes, planes, groups=self.groups,
                                base_width=self.base_width, dilation=self.dilation,
                                norm_layer=norm_layer, attention_module=attention_module,**kwargs))
